    ...
    <main className="mx-auto flex min-h-screen max-w-xl items-center px-6 py-12">
      <section className="w-full space-y-6">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-bold">Resend OTP</h1>
          <p className="mt-3 text-muted-foreground">Placeholder resend OTP route. Authentication messaging is intentionally not implemented yet.</p>
        </div>
        <Card>
          <CardHeader>
